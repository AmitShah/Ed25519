...
export interface KarmaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface Karma extends BaseContract {
  connect(runner?: ContractRunner | null): Karma;
  ...
  permitEDDSA: TypedContractMethod<
    [
      pubkey: BytesLike,
      spender: AddressLike,
      value: BigNumberish,
